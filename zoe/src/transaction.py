...
print "import \"./commitment.code\" as commitmentCheck"
print "import \"./invalidator.code\" as invalidatorCheck"
print "import \"./public_key.code\" as publicKeyCheck"
depth = input()
...
print "import \"./root.code\" as rootCheck".format(depth)
print " "
